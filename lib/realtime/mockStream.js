 ...
 *
 * Only fields that plausibly change second-to-second on a live feed are
 ...
 *
 * Deliberately NOT touched here: `score` / `scoreBreakdown` (no Score
 * Engine exists yet — TASK 06), `risk` (independent Risk Engine —
 * TASK 07), `holders` / `top10Concentration` (holder analysis —
 * TASK 14), and `auction` (Long adapter — TASK 16/17). Ticking those
 * would fake future engines' output, not simulate a market feed.
 */
